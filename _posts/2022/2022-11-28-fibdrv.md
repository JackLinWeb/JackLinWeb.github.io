...
This is the course work of *CSIE3018 - Linux Kernel Internals* of National Cheng Kung University. The goal is to create a Linux kernel module that calculates the Fibonacci sequence. The expected goals are:
